...
macro(get_default_rmw_implementation var)
  ...
  #TODO log
  message(WARNING "1 _middleware_implementations:${_middleware_implementations}")
  ...
  if("${RMW_IMPLEMENTATION}" STREQUAL "" AND
    ...
    #TODO log
    message(WARNING "2 RMW_IMPLEMENTATION1:${RMW_IMPLEMENTATION} RMW_IMPLEMENTATION2:$ENV{RMW_IMPLEMENTATION}")
    ...
    #TODO log
    message(WARNING "3 RMW_IMPLEMENTATION1:${RMW_IMPLEMENTATION} RMW_IMPLEMENTATION2:$ENV{RMW_IMPLEMENTATION}")
